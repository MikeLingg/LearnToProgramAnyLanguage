...
int main()
{
    // Most programs allow this operation, but where is the result?
    // We can't use it!
    5 + 3;
    ...
    a = c;
    c = c + 1;
    // Note the following line will prevent compiling.
    1 = a;
    ...
    freeCoffee = ( ( loyaltyMember == true ) && ( purchased5Coffees == true ) ) ||
                 ( ( haveCoupon == true ) && ( couponNotExpired == true ) );
    ...
    // Or if you want to be explicit with parenthesis
    isWeekend = ( day == SATURDAY ) || ( day == SUNDAY );
