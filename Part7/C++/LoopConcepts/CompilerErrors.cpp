...
int main()
{
    ...
    // ERROR: Trying to use range-based for loop with wrong syntax (colon missing)
    int arr[] = {1, 2, 3, 4, 5};
    ...
    // ERROR: Declaring variable inside while condition (wrong syntax)
    while (int z = getchar())
    {
        printf("%c", z);
    }
    ...
    // ERROR: Using float in loop comparison (implicit conversion warning/error in strict mode)
    ...
    // ERROR: Using range-based for with 'of' instead of colon
    for (int element of arr)
    {
        printf("%d\n", element);
    }
    ...
    // ERROR: Using 'auto' incorrectly in traditional for loop
    for (auto i = 0; i < arr; i++)
    {
        printf("%d\n", i);
    }

    // ERROR: Range-based for loop missing colon
    for (auto element arr)
    {
        printf("%d\n", element);
    }

    // ERROR: Range-based for loop with semicolon instead of colon
    for (int element; arr)
    {
        printf("%d\n", element);
    }

    // ERROR: Using 'let' for variable declaration (from other languages)
    for (let i = 0; i < 10; i++)
    {
        printf("%d\n", i);
    }

    // ERROR: Using 'var' for variable declaration (from C#/other languages)
    for (var i = 0; i < 10; i++)
    {
        printf("%d\n", i);
    }

    // ERROR: Using ampersand incorrectly in range-based for
    for (int& element in arr)
    {
        printf("%d\n", element);
    }

    // ERROR: Missing reference symbol position in range-based for
    for (int &element: arr)
    {
        printf("%d\n", element);
    }
